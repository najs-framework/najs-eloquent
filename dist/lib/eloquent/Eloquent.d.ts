...
export declare abstract class Eloquent<NativeRecord extends Object = {}> implements IEloquent, IAutoload {
    ...
    protected initialize(data: NativeRecord | Object | undefined): Eloquent<NativeRecord>;
