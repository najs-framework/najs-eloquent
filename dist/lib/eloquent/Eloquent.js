...
class Eloquent {
    ...
    initialize(data) {
        ...
        this.__knownAttributeList = Array.from(new Set(this.getReservedPropertiesList().concat(Object.getOwnPropertyNames(this), Object.getOwnPropertyNames(Eloquent.prototype), Object.getOwnPropertyNames(Object.getPrototypeOf(this)))));
