...
describe('RecordExecutorBase', function () {
    function makeExecutor(model, record) {
        return new MemoryRecordExecutor_1.MemoryRecordExecutor(model, record, {}, new MemoryQueryLog_1.MemoryQueryLog());
    }
    ...
    describe('.update()', function () {
        ...
        it('calls .fillData(false) by default then save the data by .updateRecord()', async function () {
            ...
            const record = new Record_1.Record({ id: 'id' });
    ...
    describe('.hardDelete()', function () {
        ...
        it('calls and returns this.hardDeleteRecord() if there is a primary key', async function () {
            ...
            const executor = makeExecutor(model, new Record_1.Record({ id: 'id' }));
