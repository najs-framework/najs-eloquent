...
describe('MongodbDriver.Timestamps', function () {
    ...
    beforeAll(async function () {
        await util_1.init_mongodb('mongodb_driver_timestamps');
    });
    afterAll(async function () {
        await util_1.delete_collection_use_mongodb('users');
        await util_1.delete_collection_use_mongodb('timestamp_model_defaults');
        await util_1.delete_collection_use_mongodb('custom_timestamp_models');
        await util_1.delete_collection_use_mongodb('not_static_timestamp_models');
    });
