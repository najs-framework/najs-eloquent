...
import { QueryBuilder } from '../../../lib/v0.x/query-builders/QueryBuilder'
...
describe('QueryBuilder', function() {
  ...
  describe('whereNull()', function() {
    ...
    it('calls where() with operator "=" and value from "getNullValue()"', function() {
      const query = new QueryBuilder()
      const whereSpy = Sinon.spy(query, 'where')
      const getNullValueSpy = Sinon.spy(query, <any>'getNullValue')
      query.whereNull('a')
